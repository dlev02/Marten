...
As permitted by section 7(b) of the AGPL, this program is licensed with the
following additional requirement, which applies to every copy, fork, hosted
...
Renaming the project, removing the Marten name, or hiding the credit while
still using this code is not permitted. Everything else the AGPL allows, you
may do: run it, change it, self-host it, and share it, provided your changes
are also released under the AGPL and users of a hosted copy can obtain the
source.

If you would like to use Marten under different terms, open an issue at
